...
import org.whispersystems.modusa.groups.SenderKeyName;

public interface SenderKeyStore {

  /**
   * Commit to storage the {@link org.whispersystems.modusa.groups.state.SenderKeyRecord} for a
  ...
  /**
   * Returns a copy of the {@link org.whispersystems.modusa.groups.state.SenderKeyRecord}
