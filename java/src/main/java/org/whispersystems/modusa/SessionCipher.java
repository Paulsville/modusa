...
import static org.whispersystems.modusa.state.SessionState.UnacknowledgedPreKeyMessageItems;
...
public class SessionCipher {
   ...
   * @throws InvalidKeyIdException when there is no local {@link org.whispersystems.modusa.state.PreKeyRecord}
  ...
  private static class TestInMemorySignalProtocolStore extends InMemorySignalProtocolStore {
